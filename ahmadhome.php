...
<head>
    ...
    <link rel="stylesheet" href="cvahmad.css">
    ...
    <section class="home" id="first">
        <div class="home-content">
            ...
            <div class="social-icons">
                ...
                <a href="https://www.facebook.com/ahmad.emad.522?mibextid=qWsEUC" class="facebook"><i class="fab fa-facebook-f"></i></a>
                <a href="https://www.instagram.com/ahmad_3madd/" class="instagram"><i class="fab fa-instagram"></i></a>
            </div>
        </div>
        ...
        <div class="contact-me" id="contact-me">
            ...
            <div class="contact-form">
                <form action="ahmad.php" method="POST">
